...
/*   Updated: 2022/06/17 10:34:11 by tgerdes          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	FragTrap::setHitPointsAutomatically()
{
	this->_hitPoints = 100;
}

void	FragTrap::setEnergyPointsAutomatically()
{
	this->_energyPoints = 100;
}

void	FragTrap::setAttackDamageAutomatically()
{
	this->_attackDamage = 30;
}
